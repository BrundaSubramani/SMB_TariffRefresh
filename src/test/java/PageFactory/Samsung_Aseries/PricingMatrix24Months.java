...
public class PricingMatrix24Months {

    WebDriver driver;

    public PricingMatrix24Months(WebDriver driver) {
        this.driver = driver;
    ...
    @FindBy(xpath = "(//*[@class= \"text_new1 prices tariffMonthly \"])[5]")
    WebElement monthly70gb;

    public void tariff_24month_20gb(Integer pricingmatrixupfront, String pricingmatrixmonthly) throws InterruptedException {
        ...
        String tariffmonth20gb=monthly24month20gb.getText();
    ...
    public void tariff_24month_3gb(Integer pricingupfront3gb, String pricingmonthly3gb)
    {
        ...
        String extractNumber_month=(String) tariffmonth3gb.subSequence(1,7);
        //int monthTariffExtraNumber=parseInt(extractNumber_month);
        System.out.println("Business Page Price Monthly :"+extractNumber_month);
        System.out.println("Pricing Matrix Price Monthly: "+pricingmonthly3gb);
        if(extractNumber_month.equalsIgnoreCase(pricingmonthly3gb)){
            System.out.println("Business Shop Monthly Value "+extractNumber_month+" and Pricing Matrix monthly value"+pricingmonthly3gb+" are matching");
        }
        else{
