...
public class Pricing36months {

    WebDriver driver;

    public Pricing36months(WebDriver driver) {
        this.driver = driver;
    ...
    public void tariff_36month_20gb(Integer pricingmatrixupfront, String pricingmatrixmonthly){
    ...
    public void tariff_36month_unlimited(Integer pricingupfrontunlimited, String pricingmonthlyunlimited)
    {
    ...
    public void tariff_36month_6gb(Integer pricingupfront6gb, String pricingmonthly6gb)
    {
    ...
    public void tariff_36month_70gb(Integer pricingupfront70gb, String pricingmonthly70gb)
    {
